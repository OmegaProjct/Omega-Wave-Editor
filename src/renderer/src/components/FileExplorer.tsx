...
// Custom-Symbol für ein Audio-Dateisymbol (Blatt mit gefalteter Ecke und farbigem Notenschlüssel)
const AudioFileIcon = ({ size = 16, className = "text-blue-400" }: { size?: number; className?: string }) => (
  ...
  >
    {/* Page Sheet */}
    <path 
      d="M 24 16 C 24 13.8 25.8 12 28 12 L 56 12 L 78 34 L 78 84 C 78 86.2 76.2 88 74 88 L 28 88 C 25.8 88 24 86.2 24 84 Z" 
      fill="#ffffff" 
      stroke="#1e293b" 
      strokeWidth="5" 
    ...
    {/* Folded Corner */}
    <path 
      d="M 56 12 L 56 34 L 78 34 Z" 
      fill="#cbd5e1" 
      stroke="#1e293b" 
      strokeWidth="5" 
      strokeLinejoin="round" 
    />
    {/* Treble Clef inside the sheet */}
    <g transform="translate(38.5, 36) scale(0.42)">
      <path 
        className={className}
        fill="currentColor"
